<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SkillsSection.ascx.cs" Inherits="_241611JalopPersonalWebsite.Frontend.User.Controls.SkillsSection" %>

<style>
    /* Skills Section Component Styles */
    .list-group {
        display: flex;
