# 17 - Signup.aspx Frontend & Code-Behind Guide (Dotted Grid Monochrome Edition)

## 1. Overview
**`Signup.aspx`** is styled to match the minimal, high-contrast wireframe aesthetic:
- **Background**: Pure white canvas with a subtle dotted matrix grid pattern (`radial-gradient(#cbd5e1 1.2px, transparent 1.2px)`).
- **Color Scheme**: Monochromatic high-contrast black and white (`#000000` and `#ffffff`).
- **Cards & Inputs**: Solid 2px–2.5px black outlines with smooth rounded corners (`border-radius: 10px` for inputs, `20px` for the card).
- **Eye Toggle Icon**: Clean, minimal eye stroke icon positioned on the right of the password fields matching the reference wireframe.
- **Submit Button**: High-contrast white button with bold black border (`border: 2px solid #000000`) and bold black typography that inverts to solid black on hover.

---

## 2. Page & Directory Convention
- **Web Form**: `241611JalopPersonalWebsite/Frontend/Login/Signup.aspx`
- **Code-Behind**: `241611JalopPersonalWebsite/Frontend/Login/Signup.aspx.cs`
- **Designer File**: `241611JalopPersonalWebsite/Frontend/Login/Signup.aspx.designer.cs`

---

## 3. Entire Code Snippet: `Signup.aspx`
File: `Frontend/Login/Signup.aspx`
        ...
        <div class="card">
            ...
            <form id="signupForm" runat="server">
                ...
                <asp:Panel ID="pnlFormFields" runat="server" CssClass="form-grid">
                    ...
                    <div class="terms-row">
                        <asp:CheckBox ID="chkTerms" runat="server" CssClass="terms-checkbox" Checked="true" />
                        <label for="chkTerms" class="terms-label">
...
## 4. Sequential Documentation Index
