<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EducationSection.ascx.cs" Inherits="_241611JalopPersonalWebsite.Frontend.User.Controls.EducationSection" %>

<style>
    /* Education Section Component Styles */
    .timeline-list {
        display: flex;
